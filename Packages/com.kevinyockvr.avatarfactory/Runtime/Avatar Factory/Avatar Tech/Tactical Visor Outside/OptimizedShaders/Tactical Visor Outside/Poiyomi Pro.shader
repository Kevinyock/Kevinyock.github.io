Shader "Hidden/Locked/.poiyomi/Poiyomi Pro/7cd784b477cc39e4890601d49e0a8e9c"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(1,0,0,0.1568628).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(1,0,0,0.1568628).a;
				#if defined(PROP_ALPHAMASK) || !defined(OPTIMIZER_ENABLED)
